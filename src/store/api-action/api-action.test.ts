...
describe('Async actions', () => {
  ...
  describe('fetchAllOffers', () => {
    it('should dispatch "fetchAllOffers.pending", "fetchAllOffers.fulfilled", when server response 200',
      async () => {
  ...
  it('should dispatch "fetchAllOffers.pending", "fetchAllOffers.rejected" when server response 400',
    async () => {
  ...
  it('dispatches pending and fulfilled when server returns 200',
    async () => {
  ...
  it('dispatches setOfferNotFound(true) and rejected when server returns 400',
    async () => {
  ...
  it('dispatches setOfferNotFound(true) and rejected when server returns 404',
    async () => {
      const fakeId = 'non-existing-id';
  ...
  it('dispatches pending and fulfilled for fetchNearbyOffersById when server returns 200',
    async () => {
      const sampleOffer = mockOffers[0];
      ...
      const fulfilled = actions.find((action) =>
        action.type === 'currentOffer/fetchNearbyOffersById/fulfilled') as ReturnType<
          typeof fetchNearbyOffersById.fulfilled>;
      expect(fulfilled.payload).toEqual(nearby);
    });
  it('dispatches pending and rejected for fetchNearbyOffersById when server returns 500',
    async () => {
      const sampleOffer = mockOffers[0];
  ...
  it('dispatches pending and fulfilled for fetchReviewsByOfferId when server returns 200',
    async () => {
      const sampleOffer = mockOffers[0];
      ...
      const fulfilled = actions.find((action) =>
        action.type === fetchReviewsByOfferId.fulfilled.type) as ReturnType<
          typeof fetchReviewsByOfferId.fulfilled>;
      expect(fulfilled.payload).toEqual(comments);
    });

  it('dispatches pending and rejected for fetchReviewsByOfferId when server returns 500',
    async () => {
      const sampleOffer = mockOffers[0];
  ...
  it('dispatches pending and fulfilled for fetchFavoriteAction when server returns 200',
    async () => {
      ...
      const fulfilled = actions.find((action) =>
        action.type === fetchFavoriteAction.fulfilled.type) as ReturnType<
          typeof fetchFavoriteAction.fulfilled>;
      expect(fulfilled.payload).toEqual(favorites);
    });
  it('dispatches pending and rejected for fetchFavoriteAction when server returns 500',
    async () => {
  ...
  it('dispatches pending and fulfilled for postReviewAction when server returns 200',
    async () => {
      const sampleOffer = mockOffers[0];
      const newReview = {
        id: 'r1',
      ...
      const fulfilled = actions.find((action) =>
        action.type === postReviewAction.fulfilled.type) as ReturnType<
          typeof postReviewAction.fulfilled>;
      expect(fulfilled.payload).toEqual(newReview);
    });

  it('dispatches pending and rejected for postReviewAction when server returns 500',
    async () => {
      const sampleOffer = mockOffers[0];
  ...
  it('dispatches pending and fulfilled for postFavoriteAction when server returns 200',
    async () => {
      const sampleOffer = mockOffers[0];
      ...
      const fulfilled = actions.find((action) =>
        action.type === postFavoriteAction.fulfilled.type) as ReturnType<
          typeof postFavoriteAction.fulfilled>;
      expect(fulfilled.payload).toEqual(updatedOffer);
    });

  it('dispatches pending and rejected for postFavoriteAction when server returns 500',
    async () => {
      const sampleOffer = mockOffers[0];
  ...
  it('should dispatch pending and fulfilled when server returns 200',
    async () => {
  ...
  it('should dispatch pending and fulfilled and set NoAuth when server returns 400',
    async () => {
